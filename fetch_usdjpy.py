...
if cal_resp.status_code == 200:
    ...
    print(f"FMP calendar fetch failed ({cal_resp.status_code}); defaulting to none")
    cal_events = []

high_events = [e["event"] for e in cal_events if e.get("country") == "United States" and e.get("impact") == "High"]
